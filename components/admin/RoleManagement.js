...
const PERM_TREE = [
  ...
  },
  {
    ...
    children: [
      ...
      { key: 'page.audit-roster',          label: 'Audit Roster',       desc: 'Night-shift weight audit and morning-shift weight + melting audit (two-shift workflow)' },
      { key: 'page.audit-history',         label: 'Audit History',      desc: 'Audit history log + list of auditors (the team running the shifts)' },
...
export const PERMISSION_REGISTRY = [
  {
    ...
    items: [
      ...
      { key: 'page.audit-roster',          label: 'Audit Roster',        desc: 'Two-shift audit workflow (night weight, morning weight + melting)' },
      { key: 'page.audit-history',         label: 'Audit History',       desc: 'Audit log + auditors list' },
