...
const PERM_TREE = [
  ...
  },
  {
    ...
    children: [
      ...
      { key: 'page.consignment-approvals', label: 'Consignment EWB/E-Invoice',  desc: 'Accounts approval queue (EWB/E-Invoice generation, approve/reject)' },
      ...
      { key: 'page.billed-vs-paid',        label: 'Billed vs Paid',     desc: 'Accounts reconciliation: purchased value vs money paid from bank (RazorpayX) + verified-account check' },
...
export const PERMISSION_REGISTRY = [
  {
    ...
    items: [
      ...
      { key: 'page.consignment-data',      label: 'Consignment Data',    desc: 'Detailed consignment records' },
      { key: 'page.consignment-approvals', label: 'Consignment EWB/E-Invoice',   desc: 'Accounts approval queue' },
      ...
      { key: 'page.billed-vs-paid',        label: 'Billed vs Paid',      desc: 'Accounts: billed vs paid-from-bank reconciliation' },
      { key: 'page.consignment-analytics', label: 'Movement Analytics',  desc: 'Inter-branch movement charts' },
