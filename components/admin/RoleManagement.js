...
const PERM_TREE = [
  ...
  },
  {
    ...
    children: [
      ...
      { key: 'page.collection-audit',      label: 'Collection Audit',   desc: 'At-HO weight check on inbound bills; flips stock_status to at_ho' },
...
export const PERMISSION_REGISTRY = [
  {
    ...
    items: [
      ...
      { key: 'page.collection-audit',      label: 'Collection Audit',    desc: 'At-HO weight check on inbound bills' },
      { key: 'page.consignment-analytics', label: 'Movement Analytics',  desc: 'Inter-branch movement charts' },
