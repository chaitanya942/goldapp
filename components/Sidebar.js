...
const NAV_ITEMS = [
  ...
  { id: 'purchases',    label: 'Purchases',    icon: 'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4', desc: 'Gold bought',
    children: [
      { id: 'purchase-live',    label: 'Live Data Feed',              dot: '#3aaa6a' },
      { id: 'purchase-data',    label: 'Master Purchase Data',        dot: '#c9a84c' },
      { id: 'purchase-reports', label: 'Purchase Reports & Analytics', dot: '#8c5ac8' },
    ]
  },
  { id: 'consignments', label: 'Operations', icon: 'M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4', desc: 'In transit',
    children: [
  ...
  { id: 'melting', label: 'Melting', icon: 'M17.657 18.657A8 8 0 016.343 7.343S7 9 9 10c0-2 .5-5 2.986-7C14 5 16.09 5.777 17.656 7.343A7.975 7.975 0 0120 13a7.975 7.975 0 01-2.343 5.657z', desc: 'Processing',
    children: [
      { id: 'melting-incoming', label: 'In Consignment', dot: '#e9a942' },
      { id: 'melting-at-ho',    label: 'At HO',          dot: '#3aaa6a' },
    ],
  },
  { id: 'sales',   label: 'Sales',   icon: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z', desc: 'Revenue',
    children: [
      ...
      { id: 'gold-news',         label: 'Gold News',         dot: '#8c5ac8' },
    ]
  },
...
const ADMIN_ITEMS = [
  { id: 'users', label: 'Admin', icon: 'M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z M15 12a3 3 0 11-6 0 3 3 0 016 0z', desc: 'Settings',
    children: [
      { id: 'branch-management', label: 'Branches',          dot: '#8c5ac8' },
...
const T = {
  dark: {
    ...
    gold: '#c9a84c', goldDim: 'rgba(201,168,76,.12)', goldBdr: 'rgba(201,168,76,.2)',
    goldSdw: '0 0 12px rgba(201,168,76,.06), inset 0 1px 0 rgba(201,168,76,.08)',
    goldGlow: 'rgba(201,168,76,.5)', border: '#1a1a18', border2: '#242220',
    hov: 'rgba(201,168,76,.05)', topGlow: 'radial-gradient(ellipse at top, rgba(201,168,76,.05) 0%, transparent 65%)',
    divider: 'linear-gradient(90deg, transparent, rgba(201,168,76,.12), transparent)',
    sectionClr: '#3a2e18', logoBg: 'linear-gradient(135deg, #c9a84c 0%, #7a4a10 100%)',
  ...
  light: {
    ...
    hov: 'rgba(154,114,40,.06)', topGlow: 'radial-gradient(ellipse at top, rgba(154,114,40,.04) 0%, transparent 65%)',
    divider: 'linear-gradient(90deg, transparent, rgba(154,114,40,.15), transparent)',
    sectionClr: '#c0b090', logoBg: 'linear-gradient(135deg, #b8882e 0%, #7a4a10 100%)',
    logoSdw: '0 2px 10px rgba(154,114,40,.22)',
  },
}
