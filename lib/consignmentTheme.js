...
export const CONSIGNMENT_THEMES = {
  dark: {
    ...
    text4:   '#6a5a3a',
    gold:    '#c9a84c',
    // High-contrast text for use on top of the gold accent (gold buttons,
    // gold pills). Centralized so we don't sprinkle hardcoded hex values.
    goldText: '#1a0a00',
    border:  '#1e1e1e',
    border2: '#252525',
    green:   '#3aaa6a',
    ...
    orange:  '#c9981f',
    purple:  '#8c5ac8',
    // Soft drop shadow + subtle inner highlight. Used by DashboardHome cards
    // for the elevated-surface look. Stays out of consignment cards (they're
    // flat by design); referencing it is opt-in.
  ...
  light: {
    ...
    text4:   '#9a8a6a',
    gold:    '#9a7228',
    goldText: '#ffffff',  // gold is darker in light mode → white reads better than dark text
    border:  '#e0dace',
    border2: '#c5bca8',
    green:   '#2a8a5a',
    red:     '#c03030',
