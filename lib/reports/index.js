...
import { buildPurchaseRegisterReport } from './purchaseRegisterReport'
...
export const REPORTS = {
  ...
  purchase_register: {
    ...
    description: 'Full 26-column register Excel (bank/payment details, incl. payment-pending)',
    build: buildPurchaseRegisterReport,
  },
  consignment_report: {
