...
export async function checkWorkflow(supabase, consignmentId, auth, step) {
  ...
  // No admin bypass — the workflow is the workflow. Skipping steps was the
  // original concern that motivated this gate; admins need to follow it too.
  // For genuine emergencies (data corruption, stuck row), use SQL directly to
  // backfill the missing timestamp — that's auditable and intentional.
