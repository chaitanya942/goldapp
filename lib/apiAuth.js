...
export const ROLE_GROUPS = {
  ...
  // Marketing team — field bus-advertising audit (/bus-audit capture). Admins
  // included so ops/founders can use it; the /review view stays ADMIN-only.
  BUS_AUDIT: ['super_admin', 'founders_office', 'admin', 'marketing'],
