...
export const ROLE_PAGES = {
  super_admin:     ['dashboard','purchase-data','purchase-reports','consignment-data','consignment-report','consignment-summary','melting','sales','cal-table','reports','branch-management','user-management','import-logs'],
  founders_office: ['dashboard','purchase-data','purchase-reports','consignment-data','consignment-report','consignment-summary','melting','sales','cal-table','reports','branch-management','user-management','import-logs'],
  admin:           ['dashboard','purchase-data','purchase-reports','cal-table'],
  manager:         ['dashboard','purchase-data','purchase-reports'],
  branch_staff:    ['dashboard','purchase-data','purchase-reports'],
  viewer:          ['dashboard','purchase-reports'],
}

// Actions each role CANNOT perform (hidden in UI)
