...
export const ROLE_PAGES = {
  super_admin:     ['dashboard','purchase-data','purchase-reports','consignment-overview','consignment-data','consignment-report','consignment-summary','consignment-analytics','melting','sales','cal-table','live-market-rates','reports','branch-management','branch-employees','user-management','company-settings','consignment-seeds','import-logs','inbound-bot','role-management','heatmap-insights','consignment-approvals'],
  founders_office: ['dashboard','purchase-data','purchase-reports','consignment-overview','consignment-data','consignment-report','consignment-summary','consignment-analytics','melting','sales','cal-table','live-market-rates','reports','branch-management','branch-employees','user-management','company-settings','consignment-seeds','import-logs','inbound-bot','heatmap-insights','consignment-approvals'],
  admin:           ['dashboard','purchase-data','purchase-reports','consignment-overview','consignment-data','consignment-report','consignment-summary','consignment-analytics','cal-table','live-market-rates','heatmap-insights'],
...
export function AppProvider({ children }) {
  ...
  const canSeeResolved = (key) => {
    ...
    const ALWAYS_ON_FOR_SUPER_ADMIN = new Set([
      ...
      'consignment-report', 'consignment-summary', 'consignment-analytics',
    ])
