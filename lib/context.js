...
export const ROLE_PAGES = {
  super_admin:     ['dashboard','purchase-live','purchase-data','purchase-reports','consignment-overview','consignment-data','consignment-report','consignment-summary','consignment-bidding','consignment-analytics','eod-stock-report','audit-data','audit-report','discrepancy-cases','melting','melting-incoming','melting-at-ho','sales','cal-table','live-market-rates','gold-news','reports','branch-management','branch-employees','user-management','company-settings','logistics','consignment-seeds','import-logs','inbound-bot','role-management','heatmap-insights','consignment-approvals','billed-vs-paid','gold-buying-rate','holiday-calendar'],
  founders_office: ['dashboard','purchase-live','purchase-data','purchase-reports','consignment-overview','consignment-data','consignment-report','consignment-summary','consignment-analytics','eod-stock-report','audit-data','audit-report','melting','melting-incoming','melting-at-ho','sales','cal-table','live-market-rates','gold-news','reports','branch-management','branch-employees','user-management','company-settings','logistics','consignment-seeds','import-logs','inbound-bot','heatmap-insights','consignment-approvals','billed-vs-paid','gold-buying-rate','holiday-calendar'],
  admin:           ['dashboard','purchase-live','purchase-data','purchase-reports','consignment-overview','consignment-data','consignment-report','consignment-summary','consignment-analytics','eod-stock-report','audit-data','audit-report','cal-table','live-market-rates','gold-news','heatmap-insights','gold-buying-rate','holiday-calendar'],
