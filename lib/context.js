...
export const ROLE_PAGES = {
  ...
  admin:           ['dashboard','purchase-data','purchase-reports','consignment-overview','consignment-data','consignment-report','consignment-summary','consignment-analytics','cal-table','live-market-rates','heatmap-insights','gold-buying-rate'],
