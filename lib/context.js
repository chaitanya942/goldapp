...
export const ROLE_PAGES = {
  ...
  admin:           ['dashboard','purchase-live','purchase-data','purchase-reports','consignment-overview','consignment-data','consignment-report','consignment-summary','consignment-analytics','eod-stock-report','audit-data','audit-report','cal-table','live-market-rates','heatmap-insights','gold-buying-rate'],
