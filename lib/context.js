...
export const ROLE_PAGES = {
  super_admin:     ['dashboard','purchase-live','purchase-data','purchase-reports','consignment-overview','consignment-data','consignment-report','consignment-summary','consignment-bidding','consignment-analytics','audit-data','audit-report','melting','sales','cal-table','live-market-rates','reports','branch-management','branch-employees','user-management','company-settings','logistics','consignment-seeds','import-logs','inbound-bot','role-management','heatmap-insights','consignment-approvals','gold-buying-rate'],
  founders_office: ['dashboard','purchase-live','purchase-data','purchase-reports','consignment-overview','consignment-data','consignment-report','consignment-summary','consignment-analytics','audit-data','audit-report','melting','sales','cal-table','live-market-rates','reports','branch-management','branch-employees','user-management','company-settings','logistics','consignment-seeds','import-logs','inbound-bot','heatmap-insights','consignment-approvals','gold-buying-rate'],
  admin:           ['dashboard','purchase-live','purchase-data','purchase-reports','consignment-overview','consignment-data','consignment-report','consignment-summary','consignment-analytics','audit-data','audit-report','cal-table','live-market-rates','heatmap-insights','gold-buying-rate'],
