...
// year and are hand-curated below, verified against Drik Panchang
// (Bengaluru) and other published panchangams — not computed.
//
// Coverage matches this business's FY 2026-27 (Apr 2026-Mar 2027): the
// `2026` entry runs Jan-Dec 2026 (so it also covers the tail of FY 2025-26,
// harmlessly), and the `2027` entry covers just Jan-Mar 2027 to close out
// FY 2026-27 — Ugadi/Vasanta Navaratri 2027 fall in April 2027 (FY 2027-28)
// so aren't in it. THIS FILE MUST BE REFRESHED before each new FY starts —
// add an entry for the new year covering Apr onward. A date not covered
// here silently falls back to just the weekly Tuesday/Friday rule (see
// getDayInsight below), which is the one evergreen, day-of-week-only signal
// that needs no yearly update.
...
const YEARLY_DATA = {
  ...
  // Jan–Mar 2027 — the tail of FY 2026-27 (Apr 2026–Mar 2027), this
  // business's operating year. Ugadi/Vasanta Navaratri fall in April 2027
  // (next FY) so aren't needed here; everything else that lands in this
  // window is below.
  2027: {
    amavasya: ['2027-01-07', '2027-02-06', '2027-03-08'],
    festivals: [
      { date: '2027-01-15', name: 'Makar Sankranti / Pongal' },
    ],
    ranges: [
      { from: '2027-01-15', to: '2027-02-28', name: 'Wedding season', effect: 'low', weight: 1 },
    ],
  },
}
