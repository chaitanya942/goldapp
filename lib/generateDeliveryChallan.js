...
export function generateDeliveryChallan({ consignment, branch, companySettings, items, logoBase64 }) {
  ...
  autoTable(doc, {
    ...
    footStyles: { fillColor: WH, textColor: BK, fontStyle: 'bold', valign: 'middle' },
    columnStyles: {
      0: { halign: 'center', cellWidth: 10 },
      1: { halign: 'left',   cellWidth: 74 },   // description — left
      2: { halign: 'center', cellWidth: 18 },
      3: { halign: 'center', cellWidth: 28 },   // numeric — center
      4: { halign: 'center', cellWidth: 28 },   // numeric — center
      5: { halign: 'center', cellWidth: 32 },   // numeric — center
    },
    didParseCell(d) {
      // Footer label col always center; footer amount col always center (matches data row)
    },
