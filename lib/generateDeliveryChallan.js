...
export function generateDeliveryChallan({ consignment, branch, companySettings, items, logoBase64 }) {
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // 4. BILL VERIFICATION LIST  (added per management directive — Branch staff
  //    need to verify each bill in the parcel by customer name + application
  //    ID. Per-bill weights and per-bill values are intentionally NOT shown
  //    here — only the consolidated total appears in the GST items table
  //    below. Accounts and management still see the full numbers in-app.)
  // ═══════════════════════════════════════════════════════════════════════════
  ...
  // Caption — clarifies that per-bill weights / values are deliberately
  // omitted, so a branch employee doesn't think the data is missing.
